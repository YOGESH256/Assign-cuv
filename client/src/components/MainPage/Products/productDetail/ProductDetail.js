    ...
    return (
        ...
        <div className="product__detail--container">
            ...
            <div className="detail__image--container">
                 <img src={productDetail.images.url} alt={productDetail.ListingName} className="detail__image"/>
            </div>
            </div>
            <p className="border__column"></p>
            <div className="detail__content--container">
                <div className="detail__content">
                <p>Category: <span className="product__detail--title">Generic</span></p>
                <h2 className="product__detail--title">{productDetail.title}</h2>
                <h2>Price: ${productDetail.MRP}</h2>
                <p>{productDetail.DSIN}</p>
